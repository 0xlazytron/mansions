...
export default function HelpPage() {
  const faqs = [
    {
      question: "How do I mint a Mansions of the Moon NFT?",
      answer:
        "To mint a lunar mansion NFT, first connect your wallet using the button in the navbar. Once connected, browse the collection, select the mansion you'd like, and click the 'Mint' button to proceed with the transaction.",
    },
    {
      question: "What wallet do I need?",
      answer:
        "You'll need a Web3 wallet like MetaMask to interact with the Mansions of the Moon collection. MetaMask is available as a browser extension and mobile app, and allows you to store crypto and interact with decentralized applications.",
    },
    {
      question: "How can I see my minted mansions?",
      answer:
        "Once the transaction is confirmed on the blockchain, your NFT will appear in your connected wallet. You can also view it on platforms like Rarible or Manifold by searching for your wallet address.",
    },
  ];
        ...
        <div className="space-y-16">
          ...
          <section className="bg-gradient-to-br from-[#1a1517]/80 to-[#100d0e]/80 backdrop-blur-2xl p-10 md:p-14 rounded-[3.5rem] border border-[#4a3540]/40 text-center shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative overflow-hidden group">
            ...
            <p className="text-[#9a8588] text-base md:text-lg mb-10 max-w-xl mx-auto font-medium relative z-10">
              Reach out with any questions about the Mansions of the Moon collection.
            </p>
            <Link
